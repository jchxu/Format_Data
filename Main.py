...
trackfile.save(trackname)
print(u'历史追踪数据已写入"\033[1;34;0m%s\033[0m"文件，第\033[1;34;0m%d\033[0m行.' % (trackname, writeindex+1))